"""
Icon management for the Kivy application.
Loads Material Design Icons into Kivy's global_idmap for KV file accessibility.
"""
...
def load_icons():
    """
    Loads Material Design Icons into Kivy's global_idmap.
    This makes icon unicode characters accessible globally within KV files.
    ...
    Usage in KV files:
        ...
        # Or with formatted string
        Label:
            text: f"{icon_home} Home"
            font_name: 'materialdesignicons-webfont.ttf'

    Note: You still need to set font_name to the Material Design Icons font
    to render the icons properly.
    """
    global_idmap['unicode'] = icon_unicodes
    global_idmap['icon_font'] = material_design_icons_font_path
    global_idmap['emoji_font'] = twemoji_mozilla_font_path
